...
#define NM_ERR_ADDRESS_NOT_FOUND               (NM_BASE_ERROR + 8)
#define NM_ERR_INVALID_MODE                    (NM_BASE_ERROR + 9)
#define NM_ERR_BAD_CONFIG_FILE                 (NM_BASE_ERROR + 10)
#define NM_ERR_WRITE_FAILED                    (NM_BASE_ERROR + 11)
#define NM_ERR_TIME_OUT                        (NM_BASE_ERROR + 12)
