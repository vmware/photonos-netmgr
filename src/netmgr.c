...
)
{
    ...
    GET_NETWORK_CONF_FILENAME(cfgFileName, pszInterfaceName);
...
)
{
    ...
    char cfgFileName[MAX_LINE], ipAddr[INET6_ADDRSTRLEN];
...
)
{
    ...
    {
        GET_RESOLVED_CONF_FILENAME(cfgFileName);
...
)
{
    ...
    {
        GET_NETWORKD_CONF_FILENAME(cfgFileName);
    }
